...
\begin{itemize}
    \item \texttt{lin\_fit(x, y, sigma\_y, ...)}: esegue un fit lineare pesato $y = mx + c$ con incertezze su $y$, restituisce i parametri stimati e le relative incertezze.
\end{itemize}
...
\begin{apidesc}
  \item[\textbf{Scopo}]
    Eseguire un fit lineare pesato $y = mx + c$ su un insieme di punti sperimentali con incertezze su $y$, stimando i parametri $m$ e $c$ e le loro incertezze.
