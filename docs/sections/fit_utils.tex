...
\begin{apidesc}
  ...
  \item[\textbf{Parametri}]\hfill
    ...
    \end{description}
    I parametri da \texttt{title} a \texttt{std\_alpha} sono opzionali e keyword-only, così l'ordine posizionale storico della funzione resta invariato.
    \vspace{-3pt}
  \item[\textbf{Vincoli}]
