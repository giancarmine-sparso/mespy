...
\textit{Mech Lab Tools} è una toolbox in Python che sto sviluppando per le esperienze di laboratorio del primo anno di fisica. L'obiettivo è fornire una base modulare e riutilizzabile per le operazioni ricorrenti nell'analisi dei dati sperimentali: statistica descrittiva, gestione delle incertezze, adattamento di curve ai dati e produzione di grafici.
...
Questa documentazione ha lo scopo di descrivere ogni modulo in dettaglio: le funzioni implementate, le formule matematiche sottostanti, i parametri accettati e i valori restituiti. Dando anche uno sguardo alla teoria dietro le funzioni. Costituisce un riferimento sia per l'utilizzo corretto degli strumenti sia per la verifica della correttezza delle implementazioni. 
