...
\newpage
\section{weighted\_mean(x, w=None)}
...
se non si passa un valore \textit{'w'} crea un array di tutti \text{1}, quindi ogni dato pesa uguale e si ottiene la media aritmetica classica:
...
\newpage
\section{standard\_deviation(x, w=None)}
